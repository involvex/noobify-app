...
export function ExportOptionsModal({ visible, selectedItems, onDismiss }: ExportOptionsModalProps) {
      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
          <View style={styles.header}>
            <Text style={styles.title}>Export {selectedItems.length} Items</Text>
            <IconButton
              icon="close"
              size={24}
