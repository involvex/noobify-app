			...
			<View style={styles.content}>
				<View style={styles.header}>
					<View style={styles.nameRow}>
						<Text
							style={[styles.name, !enabled && styles.nameDisabled]}
							numberOfLines={1}
						>
							{term.name}
						</Text>
					...
					<Switch
						...
						trackColor={{
							false: haloColors.border,
							true: haloColors.primaryPressed,
						}}
						thumbColor={
							enabled ? haloColors.primary : haloColors.onSurfaceMuted
						}
						style={styles.switch}
					/>
				</View>
