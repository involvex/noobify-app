...
export const aiDataTerms: TermDefinition[] = [
  {
    ...
    keyTraits: ['Data-driven', 'Pattern recognition', 'Improves with data', 'Automated'],
  ...
  },
  {
    ...
    commonComparisons: ['Machine learning', 'Classical AI', 'Statistical models'],
  },
  {
    name: 'Neural Network',
    aliases: ['ann', 'artificial neural network'],
    tags: ['ai', 'deep-learning', 'architecture'],
    whatItIs: 'a computing system inspired by biological neural networks in the brain',
    analogy:
  ...
  },
  {
    ...
    keyTraits: ['Text generation', 'Context understanding', 'Few-shot learning', 'Massive scale'],
  ...
  },
  {
    ...
    whatItIs: 'a numerical representation of text that captures semantic meaning in vector space',
    analogy:
    ...
    keyTraits: ['Dense vectors', 'Semantic similarity', 'Searchable', 'Compressed'],
  ...
  },
  {
    ...
    whatItIs: 'a database optimized for storing and searching high-dimensional vectors',
    analogy:
  ...
  },
  {
    ...
    keyTraits: ['Retrieval', 'Context injection', 'Grounded', 'Reduced hallucination'],
  ...
  },
  {
    ...
    keyTraits: ['Domain-specific', 'Less data needed', 'Specialized', 'Efficient'],
  ...
  },
  {
    ...
    whatItIs: 'the practice of crafting inputs to guide LLMs toward desired outputs',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'when an LLM generates confident-sounding but factually incorrect information',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'a parameter that controls the randomness/creativity of LLM outputs',
    analogy:
    ...
    keyTraits: ['Controls randomness', '0-2 range', 'Low=deterministic', 'High=creative'],
  ...
  },
  {
    ...
    whatItIs: 'the maximum amount of text an LLM can process in a single interaction',
    analogy:
    ...
    keyTraits: ['Token limit', 'Fixed per model', 'Affects memory', 'Cost-related'],
  ...
  },
  {
    ...
    whatItIs: 'the process of using a trained model to make predictions on new data',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'reducing model precision (e.g., from 32-bit to 4-bit) to make it smaller and faster',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'a file format for storing LLM models optimized for CPU/GPU inference',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'an open format for representing machine learning models across different frameworks',
    analogy:
    ...
    keyTraits: ['Interoperable', 'Optimized', 'Open standard', 'Hardware agnostic'],
  ...
  },
  {
    ...
    whatItIs: 'a prompting technique that asks LLMs to show their reasoning step by step',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'an AI system that can plan, use tools, and take actions to accomplish goals',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'a protocol for connecting AI models to external tools and data sources',
    analogy:
    ...
    keyTraits: ['Standardized', 'Tool integration', 'Interoperable', 'Extensible'],
  ...
  },
  {
    ...
    whatItIs: 'AI systems that can autonomously plan, reason, and execute multi-step tasks',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'a series of data processing steps that move data from source to destination',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'a centralized repository for storing structured and unstructured data at any scale',
    analogy:
  ...
  },
  {
    ...
    keyTraits: ['Structured', 'Optimized for queries', 'Historical', 'Analytics-focused'],
  ...
  },
  {
    ...
    whatItIs: "a category of databases that don't use traditional relational table structures",
    analogy:
    ...
    keyTraits: ['Flexible schema', 'Horizontal scaling', 'JSON-friendly', 'Fast'],
  ...
  },
  {
    ...
    keyTraits: ['Consistency', 'Availability', 'Partition tolerance', 'Trade-off'],
  ...
  },
  {
    ...
    keyTraits: ['Immutable events', 'Audit trail', 'Temporal queries', 'Replay'],
  ...
  },
  {
    ...
    whatItIs: 'a pattern that separates read and write operations into different models',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'a user-defined HTTP callback triggered by an event in a source system',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'controlling the number of requests a client can make to an API within a time period',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'the ability to understand internal system state from external outputs',
    analogy:
  ...
  },
  {
    ...
    whatItIs: 'the practice of deliberately introducing failures to test system resilience',
    analogy:
    ...
    keyTraits: ['Deliberate failures', 'Resilience', 'Confidence', 'Controlled'],
