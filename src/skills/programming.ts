...
export const programmingTerms: TermDefinition[] = [
	...
	},
	{
		...
		whatItIs:
			'a collection of pre-written code that you can use to perform common tasks',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a pre-built structure that defines how an application should be organized',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'an external package or module that your project relies on to function',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a region of memory used for dynamic allocation of objects and data structures',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a compilation method where code is compiled during execution rather than before',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a function passed as an argument to be executed after an operation completes',
		analogy:
