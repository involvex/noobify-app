...
export const webDevTerms: TermDefinition[] = [
	{
		...
		whatItIs:
			'a fast JavaScript/TypeScript runtime, package manager, and bundler all in one',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a stylesheet language that controls how HTML elements look on screen',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a module bundler that compiles and optimizes JavaScript files for production',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a utility-first CSS framework that lets you build designs directly in your markup',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a next-generation ORM with auto-generated queries and type safety',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a framework for building end-to-end typesafe APIs without code generation',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a browser automation library for testing web apps across all modern browsers',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a powerful open-source relational database with advanced features',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a lightweight, serverless database that runs embedded in applications',
		analogy:
	...
	},
	{
		...
		whatItIs:
			'a high-performance web server that also acts as a reverse proxy and load balancer',
		analogy:
